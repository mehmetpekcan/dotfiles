---
name: adr
description: Creates comprehensive Architectural Decision Records (ADRs) with clear rationale, alternatives, and consequences. Use when the user asks to create, draft, or formalize an architecture decision document.
---

# ADR Generator

Creates well-structured Architectural Decision Records that document important technical decisions with clear rationale, consequences, and alternatives.
...
- If the directory does not exist, start with 0001
...
5. **Be Complete**: Do not skip sections or use placeholders
