...
- `trace-audit`: Analyze Jaeger trace JSON + endpoint to find blocking Prisma/tRPC performance issues and propose prioritized fixes
...
- `/apps/frontend/` - Frontend application structure
